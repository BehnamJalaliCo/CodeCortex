...
from codecortex.mcp.server import FALLBACK_PROTOCOL, PROTOCOL_VERSION, MCPApplication, MCPServer
...
async def test_mcp_dispatch_protocol(tmp_path: Path) -> None:
    ...
    assert discovered and discovered["result"]["protocolVersion"] == FALLBACK_PROTOCOL
